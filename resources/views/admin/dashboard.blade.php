            ...
            <div class="card card-side shadow-xl bg-white text-gray-800 px-3 w-full md:w-1/4 lg:w-1/5">
                <div class="flex items-center">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-lg md:text-sm">Total TAD</p>
                    </div>
                </div>
            </div>
            <div class="card card-side shadow-xl bg-white text-gray-800 px-3 w-full md:w-1/4 lg:w-1/5">
                <div class="flex items-center">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-lg md:text-sm">TAD Hadir</p>
                    </div>
                </div>
            </div>
            <div class="card card-side shadow-xl bg-white text-gray-800 px-3 w-full md:w-1/4 lg:w-1/5">
                <div class="flex items-center">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-lg md:text-sm">TAD Sakit</p>
                    </div>
                </div>
            </div>
            <div class="card card-side shadow-xl bg-white text-gray-800 px-3 w-full md:w-1/4 lg:w-1/5">
                <div class="flex items-center">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-lg md:text-sm">TAD Izin</p>
                    </div>
                </div>
            </div>
            <div class="card card-side shadow-xl bg-white text-gray-800 px-3 w-full md:w-1/4 lg:w-1/5">
                <div class="flex items-center">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-lg md:text-sm">TAD Terlambat</p>
                    </div>
                </div>
            </div>
        </div>
